...
aaaaaa         aa      aa            aaaaaaaaa               aaaaaaa          aaaaaaa
aa   aaa       aa      aa          aa         aa             aa    aa       aa     aa
aa     aaa     aaaaaaaaaa         aa            aa           aa      aa   aa       aa
aa     aaa     aa      aa          aa         aa             aa        aa          aa
aaaaaaaaaa     aa      aa             aaaaaaaa               aa                    aa

    """)

print(banner_color + 'Photon runs only on Python 3.2 and above')
print(banner_color + "0xfff0800 - FaLaH 2.1v                      ")
...
if falah == "2":
    ketik(
        "\033[1;33m It's not free, you want to guess the two factor authentication message at $55 (snapchat connect: flash999) just accept paypal....\033[1;33m")
    time.sleep(0.5)
